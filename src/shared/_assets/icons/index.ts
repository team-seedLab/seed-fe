...
import _ArrowLeftIcon from "@/shared/_assets/icons/arrow-left.svg?react";
...
import _StudyIcon from "@/shared/_assets/icons/study.svg?react";
...
export const AdjustmentsVerticalIcon = createIcon(
  _AdjustmentsVerticalIcon,
  "AdjustmentsVerticalIcon",
);
export const ArrowLeftIcon = createIcon(_ArrowLeftIcon, "ArrowLeftIcon");
export const ArrowRightIcon = createIcon(_ArrowRightIcon, "ArrowRightIcon");
export const BeakerIcon = createIcon(_BeakerIcon, "BeakerIcon");
export const BoardTeacherIcon = createIcon(
  _BoardTeacherIcon,
  "BoardTeacherIcon",
);
...
export const StudyIcon = createIcon(_StudyIcon, "StudyIcon");
export const TerminalIcon = createIcon(_TerminalIcon, "TerminalIcon");
export const XMarkIcon = createIcon(_XMarkIcon, "XMarkIcon");
